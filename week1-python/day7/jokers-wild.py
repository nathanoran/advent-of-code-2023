...
class Hand:
    ...
    def isFiveOfAKind(self):
        if len(self.cardCounts) == 1:
            return True
        return len(self.cardCounts) == 2 and list(self.cardCounts.keys()).__contains__('J')

    def isFourOfAKind(self):
        if len(self.cardCounts) == 2:
            counts = list(self.cardCounts.values())
            return counts[0] == 4 or counts[1] == 4
        elif len(self.cardCounts) == 3 and list(self.cardCounts.keys()).__contains__('J'):
            keys = list(self.cardCounts.keys())
            keys.remove('J')
            return (self.cardCounts['J'] + self.cardCounts[keys[0]] == 4) or (self.cardCounts['J'] + self.cardCounts[keys[1]] == 4)
        return False
    ...
    def isFullHouse(self):
        if len(self.cardCounts) == 2:
            ...
            keys = list(self.cardCounts.keys())
            keys.remove('J')
            return (self.cardCounts['J'] + self.cardCounts[keys[0]] == 3) or (self.cardCounts['J'] + self.cardCounts[keys[1]] == 3)
        return False
    ...
    def isThreeOfAKind(self):
        ...
        elif len(self.cardCounts) == 4 and list(self.cardCounts.keys()).__contains__('J'):
            keys = list(self.cardCounts.keys())
            keys.remove('J')
            return (self.cardCounts['J'] + self.cardCounts[keys[0]] == 3) or (self.cardCounts['J'] + self.cardCounts[keys[1]] == 3) or (self.cardCounts['J'] + self.cardCounts[keys[2]] == 3)
        return False
    ...
    def isTwoPair(self):
        if len(self.cardCounts) == 3:
            ...
            keys = list(self.cardCounts.keys())
            keys.remove('J')
            return (self.cardCounts['J'] + self.cardCounts[keys[0]] == 2) or (self.cardCounts['J'] + self.cardCounts[keys[1]] == 2) or (self.cardCounts['J'] + self.cardCounts[keys[2]] == 2)
        return False

    def isOnePair(self):
        if len(self.cardCounts) == 4:
            return True
        return len(self.cardCounts) == 5 and list(self.cardCounts.keys()).__contains__('J')
